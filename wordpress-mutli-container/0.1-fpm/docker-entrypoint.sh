...
do {
	...
	if ($mysql->connect_error) {
		$mysql = mysqli_init();
		mysqli_ssl_set($mysql, NULL, NULL, ABSPATH . 'BaltimoreCyberTrustRoot.crt.pem', NULL, NULL); 
		mysqli_real_connect($mysql, $host, $user, $pass, '', $port, MYSQLI_CLIENT_SSL, MYSQLI_CLIENT_SSL_DONT_VERIFY_SERVER_CERT);
		if ($mysql->connect_error) {
